...
class Mamba(nn.Module):
    def __init__(self, in_channels, out_channels, seq_len=32):
        super(Mamba, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.seq_len = seq_len

        # Linear transformation for sequence modeling
    ...
    def forward(self, x):
        ...
        # Flatten the spatial dimensions (height, width) to a sequence
        x = x.view(batch_size, channels, -1)  # Flatten to (batch_size, channels, height*width)
